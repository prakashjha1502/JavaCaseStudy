...
//    private static final String URL = DBPropertyUtil.getConnectionString(fileName);
    ...
    public void generateReservationReport() throws FileNotFoundException, ClassNotFoundException, IOException {
    ...
    public void generateVehicleReport() throws FileNotFoundException, ClassNotFoundException, IOException {
